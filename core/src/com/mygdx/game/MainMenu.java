...
public class MainMenu implements Screen {
    ...
    public Texture getDaily_mission_button() {
        return daily_mission_button;
    }

    public void setDaily_mission_button(Texture daily_mission_button) {
        this.daily_mission_button = daily_mission_button;
    }
    ...
    public void render(float delta) {
        ...
        imageButton3.addListener(new ClickListener(){
                                     ...
                                     public void clicked(InputEvent event, float x, float y) {
                                         try {
                                             Deserializegame.deserialize(game);
                                         } catch (IOException e) {
