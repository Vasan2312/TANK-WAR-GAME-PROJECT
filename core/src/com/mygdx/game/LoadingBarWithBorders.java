...
public class LoadingBarWithBorders extends ProgressBar {
    ...
    public TextureRegion getLeftBorder() {
        return leftBorder;
    }

    public void setLeftBorder(TextureRegion leftBorder) {
        this.leftBorder = leftBorder;
    }

    public TextureRegion getRightBorder() {
        return rightBorder;
    }

    public void setRightBorder(TextureRegion rightBorder) {
