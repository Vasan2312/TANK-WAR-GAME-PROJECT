...
public class Setting3 implements Screen {
    ...
    Setting3(TankStar game){
        this.game=game;
        game.flag =3;
        stage = new Stage(new ScreenViewport());


        img_entry_screen = new Texture("Setting3.jpg");
        ...
        imageButton.setBounds(383, 289, 382,92);
        ...
        imageButton3.setBounds(382, 59, 382,92);
